...
{:else}
  <div class="h-full flex">
    ...
    <main class="w-full overflow-hidden flex flex-col">
      <div class="container relative h-full flex flex-col xl:px-24 pt-5 md:pt-8 xl:pt-14 pb-6">
        {#if currentStep.idx === steps.game.idx}
          <div
          ...
          >
            <h1 class="md:block hidden font-medium text-1.5xl text-white leading-none mb-3">{currentStep.title}</h1>
            ...
            {:else}
              <div class="flex">
                <div class="flex flex-col">
                  <h1 class="md:block hidden font-medium text-1.5xl text-white leading-none mb-3">
                    {currentStep.title}
                  </h1>
                  <p class="text-sm text-neutrals-l40 leading-normal mb-5 xl:mb-8">{currentStep.subtitle}</p>
                </div>
                {#if isBookingForTeam}
                  <img
                    class="md:block object-cover hidden rounded-lg team-avatar ml-auto"
              ...
              {#if isShowingGameQuestions}
                <div class="flex">
                  ...
                  <div class="w-1/4 2xl:w-1/5 hidden md:flex flex-col mt-14 mr-4">
                    <span
                      class="self-start font-medium text-xs text-functional-b10 uppercase border border-functional-b10 rounded-md tracking-0 leading-none.08 py-1 px-2 mb-3">
                      Tip
                    </span>
